...
export const EDIT_CATEGORY_FETCH_STATE = "EDIT_CATEGORY_FETCH_STATE";
export const ADD_CATEGORY_FETCH_STATE = "ADD_CATEGORY_FETCH_STATE";
export const REFRESH_LIST_CATEGORIES = "REFRESH_LIST_CATEGORIES";
